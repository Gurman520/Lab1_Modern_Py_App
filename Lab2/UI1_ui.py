...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(534, 510)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.pushButton = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton.setGeometry(QtCore.QRect(400, 320, 93, 28))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.radioButton_2.setText(_translate("MainWindow", "Желтый"))
        self.radioButton_3.setText(_translate("MainWindow", "Белый"))
        self.radioButton_4.setText(_translate("MainWindow", "Синий"))
        self.radioButton_5.setText(_translate("MainWindow", "Черный"))
        self.radioButton_6.setText(_translate("MainWindow", "Зеленый"))
        self.radioButton_7.setText(_translate("MainWindow", "Красный"))
        self.radioButton_8.setText(_translate("MainWindow", "Желтый"))
        self.radioButton_9.setText(_translate("MainWindow", "Белый"))
        self.radioButton_10.setText(_translate("MainWindow", "Синий"))
        self.radioButton_11.setText(_translate("MainWindow", "Черный"))
        self.radioButton_12.setText(_translate("MainWindow", "Зеленый"))
        self.radioButton_13.setText(_translate("MainWindow", "Красный"))
        self.radioButton_14.setText(_translate("MainWindow", "Желтый"))
        self.radioButton_15.setText(_translate("MainWindow", "Белый"))
        self.radioButton_16.setText(_translate("MainWindow", "Синий"))
        self.radioButton_17.setText(_translate("MainWindow", "Черный"))
        self.radioButton_18.setText(_translate("MainWindow", "Зеленый"))
